            ...
            <div>
                ...
                <body>
                    <div class = "centerAdmin">
                        ...
                        <form method = "post">
                            <div class="txt_field">
                            <input type="text" required name="admin_username" defaultValue = "darcyjoyce"></input>
                            ...
                            <div class="txt_field">
                            <input type="text" required name="admin_phone_number" defaultValue = "09238716584"></input>
                            ...
                            <div class="txt_field">
                            <input type="text" required name="admin_position" defaultValue = "BSCS-3"></input>
                            <label>Course</label>
                            </div>
                        ...
                        style={{
                            ...
                            variant="contained" onClick={() => {navigate('/' + 'StudentListDelete')}}>Delete</Button>
                        <Button 
                        style={{
                                marginRight: "15px",
                                marginLeft: "15px",
                            ...
                            variant="contained" onClick={() => {navigate('/' + 'StudentListUpdate')}}>Confirm</Button>
                        <Button
                        style={{
                            ...
                            variant="outlined" onClick={() => {navigate('/' + 'StudentListAdd')}}>Cancel</Button>
                    </div>
                 </body>
