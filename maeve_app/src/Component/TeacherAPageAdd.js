                    ...
                    <div class = "centerAdmin">
                        ...
                        <form method = "post">
                            ...
                            <ThemeProvider theme={theme}>
                                <Button style={{ fontSize: '20px' }} color="neutral" onClick={() => {navigate('/' + 'StudentPageAdd')}}></Button>
                            </ThemeProvider>
                        </form>
                        <Button 
                        style={{
                            ...
                            variant="contained" onClick={() => {navigate('/' + 'StudentListAdd')}}>Confirm</Button>
                        <Button
                        style={{
                            ...
                            variant="outlined" onClick={() => {navigate('/' + 'StudentList')}}>Cancel</Button>
                    </div>
                 </body>
